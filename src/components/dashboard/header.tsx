...
export function DashboardHeader() {
  ...
  return (
    <header className={cn(
      "z-10 flex h-14 items-center justify-between border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 px-6",
      preferences.navbarBehavior === "sticky" && "sticky top-0"
    )}>
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 rounded-lg border bg-muted/50 px-3 py-1.5 text-sm text-muted-foreground cursor-pointer hover:bg-muted transition-colors">
