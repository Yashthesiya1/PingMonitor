      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl font-bold text-white leading-tight mb-4">
            Know when your APIs<br />go down before<br />your users do.
          </h1>
          <p className="text-white/70 text-sm max-w-md">
            Monitor websites, APIs, and AI services in real-time.
          </p>
        </div>
        <div className="relative z-10 flex items-center gap-8">
          <div><p className="text-2xl font-bold text-white">20+</p><p className="text-xs text-white/60">Services</p></div>
          <div><p className="text-2xl font-bold text-white">1min</p><p className="text-xs text-white/60">Check interval</p></div>
          <div><p className="text-2xl font-bold text-white">6</p><p className="text-xs text-white/60">Alert channels</p></div>
        </div>
      </div>
        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" autoFocus disabled={loading} />
            </div>
            <div className="space-y-2">
              <Label htmlFor="password">Password</Label>
              <div className="relative">
                <Input id="password" type={showPassword ? "text" : "password"} placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" disabled={loading} className="pr-10" />
